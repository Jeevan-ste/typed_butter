...
file1 = open("employee_input.txt","r")
for x in file1:
    count+=1
    if count>=5 :
        (key, val) = x.split(": ")
...
f.write("The difference between the chosen goodie with highest price and the lowest price is "+str(differencePrice))
f.close()
